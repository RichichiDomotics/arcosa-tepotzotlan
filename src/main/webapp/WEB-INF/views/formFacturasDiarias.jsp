...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $(".consultarFactuDiaria").click(function(){
      fechaini=$("#fecini").val();
      fechafin=$("#fecfin").val();

      $.ajax("getFacturasConcepto",{
        "type": "POST",
        "beforeSend": function() {
        ...
        "error": function(result) {
          bootbox.alert("error al consultar las facturas por Fecha");
        },
...
<section class="container">
  <h1 class="item_name">Facturas por Rubro</h1>
  ...
  <section class="grupodedatosRetemes">
    <div class="bloquedata">
      ...
      <div class="form-group">
        <br>
        <button class="btn btn-primary btn-small consultarFactuDiaria" type="button">
