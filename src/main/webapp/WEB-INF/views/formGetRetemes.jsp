...
<h1 class="item_name"><fmt:message key="consultaretemes.heading"/></h1>
<h3 class="item_name"><fmt:message key="consultaretemes.subtitle"/></h3>
<form:form method="post" action="consultaRetemes">
<section class="grupodedatosRetemes">
<div class="bloquedata">
    
  	<div class="form-group">
  		<label for="ID_CLIENTEC">CLIENTE</label>
    	<select id="ID_CLIENTEC" name="ID_CLIENTEC" class="form-control" required>
    		<option value="" > <fmt:message key="entradas.select"/> </option>
        		<c:forEach items="${clientes}" var="client">
      				<option value="${client.idCliente}"> 
      					<c:out value="${client.idCliente} ${client.nombreCliente}"/>
      				</option>
    			</c:forEach>
    	</select>
    	<div id="comboServicios">
  	        <label>FOLIO RETEME</label>
			<input type='text' placeholder="FOLIO RETEME" id="FOLIORETEME" name='FOLIORETEME' value='' class="form-control">
        </div>
		<div id="RD">
  	...
  	<div class="form-group">	
  		<br>
  		<button class="btn btn-primary btn-small consultaRetemes" type="button">
