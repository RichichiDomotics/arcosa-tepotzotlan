...
<script>
    $(document).ready(function(){
        ...
        $(".busca").click(function(){
            ...
            urlenvio= "getTiemposAtencion";
            //frmname= $("#frmDiafec");

            var options = {
                target:    '#resultadoBuscaData',   // target element(s) to be updated with server response
                url:       urlenvio,
            ...
            $("#frmDiafec").ajaxForm(options);
            $("#frmDiafec").submit();
            return false;
        });

        showRequest = function(){
            $("#resultadoBuscaData").css("color","#000");
            $("#resultadoBuscaData").css("font-size","35px");
            $('#resultadoBuscaData').html("Consultando...");
        };

        showResponse = function(){
            $("#resultadoBuscaData").css("font-size","14px");
        };
...
<div style="display: block;" class="widget-body-inner">
    <div class="widget-main">
        <form:form id="frmDiafec" name="frmDiafec" method="post" role="form">
