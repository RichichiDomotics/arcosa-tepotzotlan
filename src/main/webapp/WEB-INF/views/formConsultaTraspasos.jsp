...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $(".consultaTraspasos").click(function(){
      consecutivo=$("#consecutivo").val();
      fechaini=$("#fecini").val();
      fechafin=$("#fecfin").val();
      $.ajax("consultaTraspasos",{
        "type": "POST",
        "beforeSend": function() {
        ...
        "data": {consecutivo : consecutivo, fechaini:fechaini,fechafin:fechafin},
        "async": true
      });
    });
...
<section class="container">
  <h1 class="item_name">Consulta Historial Traspasos Camara</h1>
    ...
    <section class="grupodedatosRetemes">
      <div class="bloquedata">
        ...
        <div class="form-group">
          <div id="RD">
            <label>RECIBO DE ENTRADA (RD)</label>
            <input type='text' placeholder="RD" id="consecutivo" name='consecutivo' value='' class="form-control">
          </div>
                ...
                <div class="bloquedata">
                  <div class="form-group">
                    <div class="row-fluid input-append">
                      ...
                      <input class="span3 date-picker" data-date-format="yyyy-mm-dd" type='text' id="fecini" name='fecini' placeholder="DD/MM/AAAA" value='' maxlength="10">
                					<span class="add-on">
										<i class="icon-calendar"></i>
									</span>
                      <div class="row-fluid input-append">

                        <input class="span3 date-picker" data-date-format="yyyy-mm-dd" type='text' id="fecfin" name='fecfin' value='' placeholder="DD/MM/AAAA" maxlength="10">
               	 						<span class="add-on">
											<i class="icon-calendar"></i>
										</span>
                      </div>
        ...
        <div class="form-group">
          <br>
          <button class="btn btn-primary btn-small consultaTraspasos" type="button">
