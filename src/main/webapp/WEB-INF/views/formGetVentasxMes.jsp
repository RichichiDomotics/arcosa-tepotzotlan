...
<script type="text/javascript" src="resources/js/ventas.js"></script>
...
<h1 class="item_name">Reporte de Ventas por Ejecutivo</h1>
...
<section class="grupodedatosRetemes">
	<div class="bloquedata">
		...
		<div class="form-group">
			<br>
			<button class="btn btn-primary btn-small consultaVentasMes" type="button">
