...
<ul class="nav nav-tabs" >
	...
	-->
	<c:if test="${(rolef eq 'ROLE_OPERACION') || (rolef eq 'ROLE_ADMIN')  || (rolef eq 'ROLE_FACTURACION')  || (rolef eq 'ROLE_TIF') || (rolef eq 'ROLE_AUDITORIA')}">
		<li role="presentation" class="dropdown">
			<a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-expanded="false">
...
-->
	...
	<c:if test="${(rolef eq 'ROLE_COMERCIAL') || (rolef eq 'ROLE_FACTURACION') ||(rolef eq 'ROLE_ALMACENISTA')|| (rolef eq 'ROLE_OPERACION') ||(rolef eq 'ROLE_COMERCIAL_GERENTE') || (rolef eq 'ROLE_ADMIN') ||(rolef eq 'ROLE_EJECUTIVO') || (rolef eq 'ROLE_AUDITORIA')|| (rolef eq 'ROLE_TIF')}">
		<li role="presentation" class="dropdown">
			<a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-expanded="false">
	...
	<c:if test="${(rolef eq 'ROLE_FACTURACION') ||(rolef eq 'ROLE_ALMACENISTA')|| (rolef eq 'ROLE_OPERACION') || (rolef eq 'ROLE_ADMIN')}">
		<li role="presentation" class="dropdown">
			...
			<ul class="dropdown-menu" role="menu">
				...
				<li class="hover">
					<a href="<c:url value="/impSal" />">
						<i class="icon-film fa fa-caret-right"></i>
						Impresi&oacute;n de Salidas Version 2
					</a>
					<b class="arrow"></b>
				</li>
			</ul>
