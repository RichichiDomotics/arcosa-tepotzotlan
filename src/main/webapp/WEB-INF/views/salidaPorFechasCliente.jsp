<form:form id="frmDiaFC" name="frmDiaFC" method="post" role="form" action="reporteSalidaPorFechasClres">
        ...
        <div class="form-group">
          <div class="row-fluid input-append">
            ...
            <div class="row-fluid input-append">
			 ...
			 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			 <button class="btn btn-primary btn-small busca" type="button" frmname="frmDiaFC"  urlenvio = "reporteSalidaPorFechasClres">
