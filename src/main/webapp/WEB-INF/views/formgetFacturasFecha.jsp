...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $(".consultarFactu").click(function(){
      fechaini=$("#fecini").val();

      $.ajax("getFacturasFecha",{
        "type": "POST",
        "beforeSend": function() {
...
<section class="container">
  <h1 class="item_name">Consulta Facturas por D&iacute;a</h1>
  ...
  <section class="grupodedatosRetemes">
    <div class="bloquedata">
      ...
      <div class="form-group">
        <br>
        <button class="btn btn-primary btn-small consultarFactu" type="button">
