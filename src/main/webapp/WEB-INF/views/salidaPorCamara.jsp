<form:form id="porCamara" name="porCamara" method="post" role="form" action="reporteSalidaPorCamarares">
  <section class="grupodedatosreporte">
  	<div class="bloquedata">
  		<div class="form-group">
  			<div class="row-fluid">
				<label for="fechaInicioXFechasCliente">Salidas por Camara</label>
			</div>
        </div>
        <div class="form-group">
          <div class="row-fluid input-append">
            ...
            <div class="row-fluid input-append">
                ...
                <span class="add-on">
			 	...
			 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
                <button class="btn btn-primary btn-small busca" type="button" frmname="porCamara"  urlenvio = "reporteSalidaPorCamarares">
