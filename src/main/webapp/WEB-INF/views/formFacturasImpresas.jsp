...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $(".consultarFactuImp").click(function(){
      fechaini=$("#fecini").val();
      fechafin=$("#fecfin").val();

      $.ajax("getFacturasImpresas",{
        "type": "POST",
        "beforeSend": function() {
...
<section class="container">
  <h1 class="item_name">Facturas Impresas</h1>
  ...
  <section class="grupodedatosRetemes">
    <div class="bloquedata">
      ...
      <div class="form-group">
        <br>
        <button class="btn btn-primary btn-small consultarFactuImp" type="button">
